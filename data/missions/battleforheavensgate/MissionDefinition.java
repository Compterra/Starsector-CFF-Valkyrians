...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.addBriefingItem("You are badly outnumbered. Fight carefully.");
		api.addBriefingItem("Commit all ships. Hold the gate at any cost!");
		api.addBriefingItem("The battlespace is huge. Maintain your line and avoid encirclement.");
