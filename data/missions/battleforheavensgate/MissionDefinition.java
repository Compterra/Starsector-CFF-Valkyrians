...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "Governorate Defense Fleet and Valkyrian Reinforcements");
		api.setFleetTagline(FleetSide.ENEMY, "Hegemony Invasion Force and Contracted Auxiliaries");
		
		// These show up as items in the bulleted list under 
		// "Tactical Objectives" on the mission detail screen
		api.addBriefingItem("You are badly outnumbered. Trade space for time and preserve the line.");
		api.addBriefingItem("Commit all ships. Heaven's Gate must not fall.");
		api.addBriefingItem("The battlespace is huge. Keep the fleet together and avoid encirclement.");
		
		// Set up the player's fleet.  Variant names come from the
		// files in data/variants and data/variants/fighters
		api.addToFleet(FleetSide.PLAYER, "valk_vatican_I_S", FleetMemberType.SHIP, "VKS Kaori", true);		
		api.addToFleet(FleetSide.PLAYER, "valk_yoshura_prime_AS", FleetMemberType.SHIP, "VKS Valkyria", true);
		api.addToFleet(FleetSide.PLAYER, "valk_almire_III_A", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_nirvana_II_A", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_nirvana_II_A", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_nirvana_II_A", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_nirvana_I_A", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_almire_II_A", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_almire_II_A", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_almire_II_A", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_nirvana_I_A", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_nirvana_I_A", FleetMemberType.SHIP, false);
		...
		api.addToFleet(FleetSide.PLAYER, "valk_eclair_A", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_eclair_A", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_elysium_A", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_elysium_A", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_elfheim_A", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_elfheim_A", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_elfheim_A", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_elfheim_A", FleetMemberType.SHIP, false);
		...
		api.addToFleet(FleetSide.PLAYER, "valk_elfheim_S", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_elfheim_S", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_inquisitor_A", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "valk_inquisitor_A", FleetMemberType.SHIP, false);
		...
		api.addToFleet(FleetSide.PLAYER, "valk_lightning_wing", FleetMemberType.FIGHTER_WING, false);
		api.addToFleet(FleetSide.PLAYER, "valk_lightning_wing", FleetMemberType.FIGHTER_WING, false);		
		api.addToFleet(FleetSide.PLAYER, "valk_azgard_wing", FleetMemberType.FIGHTER_WING, false);
		api.addToFleet(FleetSide.PLAYER, "valk_azgard_wing", FleetMemberType.FIGHTER_WING, false);
		api.addToFleet(FleetSide.PLAYER, "valk_azgard_wing", FleetMemberType.FIGHTER_WING, false);
		api.addToFleet(FleetSide.PLAYER, "valk_azgard_wing", FleetMemberType.FIGHTER_WING, false);
		api.addToFleet(FleetSide.PLAYER, "valk_azgard_wing", FleetMemberType.FIGHTER_WING, false);
